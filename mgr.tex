...
\begin{itemize}
    ...
    \item Let $Part(X,Y) = \forall_x \ (x \in X \lor x \in Y) \land (x \in X \implies x \notin Y) \land (x \in Y \implies x \notin X)$ state that the sets $X$ and $Y$ form a partition of the whole model.
